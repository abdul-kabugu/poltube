...
export default function Privacy() {
  return (
    <Box alignSelf="start"  w="80%" px={4} mx="auto">
         <Heading fontSize="xl" mb={6}>Privacy</Heading>
         <Text fontSize="lg" fontWeight="semibold">
         At Poltube, we understand the importance of privacy and are committed to protecting the personal information of our users. We do not collect or store any user data, including IP addresses or browser history. We use a decentralized network built on Subsocial to ensure that all data is encrypted and stored securely.
